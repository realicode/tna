package com.realaicy.tna.demos.webshowcase.modules.system.myfav.web.sa;
 ...
 */
@Controller
@RequestMapping("/sa/myfav")
public class SAＭyFavController {
    ...
    public String greeting(@RequestParam(value = "name", required = false, defaultValue = "World")
        ...
        return "sa/realaicy/myfav/dashboard";
    }
